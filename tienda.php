...
<div class="container-fluid">
    <a class="navbar-brand" href="inicio.php">Tienda de electronica</a>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="precio" type="hidden" id="precio" value="1600" />
        <input name="titulo" type="hidden" id="titulo" value="articulo 1" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="mando.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Mando de consola</h5>
                        <p class="card-text">Descripción: Mando inalambrico para consola o pc</p>
                        <p class="card-text">Precio $1600</p>
...
<div class="card m-4" style="width: 18rem;">
        <form id="formulario" name="formulario" method="post" action="cart.php">
        <input name="precio" type="hidden" id="precio" value="12000" />
        <input name="titulo" type="hidden" id="titulo" value="articulo 2" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="s21fe.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Samsung S21FE</h5>
                        <p class="card-text">Descripción: SmartFon de la marca Samsung</p>
...
<div class="card m-4" style="width: 18rem;">
        <form id="formulario" name="formulario" method="post" action="cart.php">
        <input name="precio" type="hidden" id="precio" value="8000" />
        <input name="titulo" type="hidden" id="titulo" value="articulo 3" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="seriess.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Consola Xbox Series S</h5>
                        <p class="card-text">Descripcion: Consola de video juegos</p>
